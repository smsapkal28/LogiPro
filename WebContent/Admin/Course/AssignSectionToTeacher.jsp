	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title" style="background-color: #1ABB9C;">
						<h2 style="color: #fff;">| Assign Section To Teacher</h2>
			...
			<!-- <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title" style="background-color:#1ABB9C;">
                    <h2 style="color:#fff;"> <li class="fa fa-reorder">  |</li>Assign Subject List</h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                  ...
                  <div class="btn-group pull-left" role="group" aria-label="...">
					...
					<button type="button" class="btn btn-danger pull-right"><li class="fa fa-file-excel-o fa-1x"></li>  Export to Excel</button>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>2011/04/25</td>
                          <td>$320,800</td>
                          <td><button type="button" class="btn btn-sm btn-info"><li class="fa fa-trash-o fa-1x"></li></button></td>
                        </tr>
                        <tr>
                          <td>Garrett Winters</td>
                          <td>Accountant</td>
